...
a finite set of states and move between neighbouring states in discrete time steps, as well as
...
of uniformly sized cells, each classified as free or occupied. Robots move between neighbouring
