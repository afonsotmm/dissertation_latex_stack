...
In MRPP settings, Dijkstra's algorithm is often used as a baseline within more complex coordination
frameworks, serving as a reference point for evaluating the benefits of more advanced search
strategies.
