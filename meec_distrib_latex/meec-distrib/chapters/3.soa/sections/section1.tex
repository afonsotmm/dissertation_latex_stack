...
and retaining forward vertices \(v\) satisfying

\begin{equation}
    g(v) + d_{\mathrm{true}}(v,g_n) \leq T,
\end{equation}
where \(g(v)\) is the cost from the current position to \(v\), \(d_{\mathrm{true}}(v,g_n)\) is the
